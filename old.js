...
// window.scrollBy(0, 400) - с точки на которой находишься
// window.scrollTo(0,400)  - с начала страницы
...
class ColoredRectangleWithText extends Rectangle {
    constructor(height, width, text, bgColor) {
      super(height, width); // вызывает строки с родителя; супер всегда первый
      this.text = text;
